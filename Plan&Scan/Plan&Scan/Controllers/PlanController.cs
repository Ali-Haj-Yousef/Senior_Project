                            ...
                            foreach (var examCode in examCodes)
                            {
                                ...
                                foreach (String course in courses)
                                {
                                    ...
                                    foreach (String room in rooms)
                                    {
                                        ...
                                        int pagesNb = (int)Math.Ceiling((float)registrations.Count / 30);
                                        ...
                                        for (int i = 1; i <= pagesNb; i++)
                                        {
                                            ...
                                            document.Add(CreateRegistrationsTable(registrations.Take(30).ToList()));

                                            if (i != pagesNb)
                                                registrations.RemoveRange(0, 30);
